  ...
  return (
    <div
      className={`flex justify-center items-center p-6 ${
        isDark ? "bg-gray-950 text-gray-100" : "bg-transparent text-gray-900"
      } transition-colors`}
    >
      <div
        className={`p-8 rounded-xl shadow-lg w-100 ${
          isDark ? "bg-gray-900 shadow-gray-700/50" : "bg-white"
        }`}
      >
        <img
          src={user.image}
          alt={user.firstName}
          className="w-32 h-32 rounded-full mx-auto mb-4 ring-2 ring-blue-500"
        />
